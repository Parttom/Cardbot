...
#define I_DIAG_PIN                          PG11  // I-STOP (using Z2_DIAG_PIN as placeholder)
#define J_DIAG_PIN                          PG12  // J-STOP (using E0_DIAG_PIN as placeholder)
...
//
  ...
  #endif
  #if _ENDSTOP_IS_ANY(_IMIN_) || _ENDSTOP_IS_ANY(_IMAX_)
    #define NEEDS_I_MINMAX 1
  #endif
  #if _ENDSTOP_IS_ANY(_JMIN_) || _ENDSTOP_IS_ANY(_JMAX_)
    #define NEEDS_J_MINMAX 1
  #endif  
...
//
  ...
  #if X_HOME_TO_MIN
    #define X_MAX_PIN                X_DIAG_PIN  // X_MAX_PIN
  #else
    #define X_MIN_PIN                X_DIAG_PIN  // X_MIN_PIN
  #endif
  ...
  #endif
  #ifndef X_MAX_PIN
    #define X_MAX_PIN                E0_DIAG_PIN  // X_MAX_PIN
  #endif
#else
...
// #endif
  ...
  #if Y_HOME_TO_MIN
    #define Y_MAX_PIN                Y_DIAG_PIN  // Y_MAX_PIN
  #else
    #define Y_MIN_PIN                Y_DIAG_PIN  // Y_MIN_PIN
  #endif
#elif NEEDS_Y_MINMAX
  #ifndef Y_MIN_PIN
    #define Y_MIN_PIN                 Y_DIAG_PIN  // Y_MIN_PIN
  #endif
  #ifndef Y_MAX_PIN
    #define Y_MAX_PIN                E1_DIAG_PIN  // Y_MAX_PIN
  #endif
#else
...
// #endif
  ...
  #if Z_HOME_TO_MIN
    #define Z_MAX_PIN                Z_DIAG_PIN  // Z_MAX_PIN
  #else
    #define Z_MIN_PIN                Z_DIAG_PIN  // Z_MIN_PIN
  #endif
#elif NEEDS_Z_MINMAX
  #ifndef Z_MIN_PIN
    #define Z_MIN_PIN                 Z_DIAG_PIN  // Z_MIN_PIN
  #endif
  #ifndef Z_MAX_PIN
    #define Z_MAX_PIN                E2_DIAG_PIN  // Z_MAX_PIN
  #endif
#else
...
// #endif
  ...
  #if I_HOME_TO_MIN
    #define I_MAX_PIN                I_DIAG_PIN  // I_MAX_PIN
  #else
    #define I_MIN_PIN                I_DIAG_PIN  // I_MIN_PIN
  #endif
#elif NEEDS_I_MINMAX
  #ifndef I_MIN_PIN
    #define I_MIN_PIN                 I_DIAG_PIN  // I_MIN_PIN
  #endif
  #ifndef I_MAX_PIN
    #define I_MAX_PIN                E3_DIAG_PIN  // I_MAX_PIN
  #endif
#else
  #define I_STOP_PIN                  I_DIAG_PIN  // I-STOP
#endif

#ifdef J_STALL_SENSITIVITY
  #define J_STOP_PIN                  J_DIAG_PIN
  #if J_HOME_TO_MIN
    #define J_MAX_PIN                J_DIAG_PIN  // J_MAX_PIN
  #else
    #define J_MIN_PIN                J_DIAG_PIN  // J_MIN_PIN
  #endif
#elif NEEDS_J_MINMAX
  #ifndef J_MIN_PIN
    #define J_MIN_PIN                 J_DIAG_PIN  // J_MIN_PIN
  #endif
  #ifndef J_MAX_PIN
    #define J_MAX_PIN                E3_DIAG_PIN  // J_MAX_PIN
  #endif
#else
